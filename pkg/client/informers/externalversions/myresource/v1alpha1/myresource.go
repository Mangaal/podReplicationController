...
import (
	"context"
	myresourcev1alpha1 "podReplicationController/pkg/apis/myresource/v1alpha1"
	versioned "podReplicationController/pkg/client/clientset/versioned"
	internalinterfaces "podReplicationController/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "podReplicationController/pkg/client/listers/myresource/v1alpha1"
	time "time"
